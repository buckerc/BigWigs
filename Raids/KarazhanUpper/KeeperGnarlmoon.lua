...
L:RegisterTranslations("enUS", function()
	return {
		...
		msg_midHp = "Keeper Gnarlmoon < 75% - Owls Soon (@ 66%)!",
		msg_lowHp = "Keeper Gnarlmoon < 40% - Owls Soon (@ 33%)!",
...
function module:CheckHps()
	...
	if self.gnarlHealth < 40 and self.lowHp == nil then
		self.lowHp = true
...
--/run local m=BigWigs:GetModule("Keeper Gnarlmoon"); BigWigs:SetupModule("Keeper Gnarlmoon");m:OnDisengage()
